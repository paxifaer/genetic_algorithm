...
void SixPiece::InitPopulationForTrain(std::shared_ptr<TrainPiectElement> board)
{
    ...
    int i1_step = 200,i2_step = 100,i3_step = 80,i4_step = 40,i5_step = 20,i6_step = 8,i7_step = 1,i8_step = 1;
    std::vector<int>  huowu,shuanghuosi,danhuosi, miansi, huosan, miansan, huoer;
    for(int i=1;i<=3;i++)
    {
